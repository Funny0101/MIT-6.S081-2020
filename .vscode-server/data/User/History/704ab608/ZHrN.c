...
pagetable_t kvmmake()
{
  ...
  mappages(kernel_pagetable, KERNBASE,(uint64)etext-KERNBASE, KERNBASE, PTE_R | PTE_W);
  ...
  mappages(kernel_pagetable, TRAMPOLINE,PGSIZE, (uint64)trampoline, PTE_R | PTE_W);
