...
copyin(pagetable_t pagetable, char *dst, uint64 srcva, uint64 len)
{
  ...
  /*copyin主体替换为对copyin_new的调用*/
  return copyin_new(pagetable, dst, srcva, len); // NEW
}
...
copyinstr(pagetable_t pagetable, char *dst, uint64 srcva, uint64 max)
{
  ...
  /*copystr主体替换为对copystr_new的调用*/ 
  return copyinstr_new(pagetable, dst, srcva, max); // NEW
}
